		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(LAYER_OPAQUE, 36, 0, 0, spindrift_000_offset_002_mesh),
						GEO_ANIMATED_PART(LAYER_ALPHA, 36, 0, 0, NULL),
						GEO_ANIMATED_PART(LAYER_ALPHA, 36, 0, 0, NULL),
						GEO_ANIMATED_PART(LAYER_OPAQUE, -88, -32, 0, NULL),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, spindrift_000_offset_003_mesh),
