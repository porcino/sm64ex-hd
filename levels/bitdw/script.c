...
const LevelScript level_bitdw_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BREAKABLE_BOX_SMALL,     breakable_box_hmc_geo),
    ...
    AREA(/*index*/ 1, geo_bitdw_000618),
        ...
        OBJECT(/*model*/ 0xF2,                  /*pos*/ -3100, -2938, 3530, /*angle*/ 0, 0, 0,  /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
        OBJECT(/*model*/ 0xF2,                  /*pos*/  3922,  1749,   -7, /*angle*/ 0, 0, 0,  /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
