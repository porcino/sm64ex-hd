...
const LevelScript level_wf_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(0x3B,                                   flowers_geo),
    ...
    AREA(/*index*/ 1, wf_geo_000BF8),
        ...
        OBJECT(/*model*/ 0x3B,       /*pos*/  4600,  256,   141, /*angle*/ 0, 45, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
        OBJECT(/*model*/ 0x3B,       /*pos*/  4600,  256,  1130, /*angle*/ 0,150, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
        OBJECT(/*model*/ 0x3B,       /*pos*/  4600,  256,  5017, /*angle*/ 0,  0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
        OBJECT(/*model*/ 0x3B,       /*pos*/  3000,  256,  5200, /*angle*/ 0,-90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
