...
const LevelScript level_wdw_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(0xF2,                                    purple_switch_base_geo),
    ...
    AREA(/*index*/ 1, wdw_geo_000658),
        ...
        OBJECT(/*model*/ 0xF2,       /*pos*/   920, 2313, -840, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
        OBJECT(/*model*/ 0xF2,       /*pos*/  3360, 1289, 3420, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
    ...
    AREA(/*index*/ 2, wdw_geo_000724),
        OBJECT(/*model*/ 0xF2,  /*pos*/  -1523, -2506, -1940, /*angle*/ 0, 0, 2, /*behParam*/ 0x00000000, /*beh*/ bhvFlowers),
