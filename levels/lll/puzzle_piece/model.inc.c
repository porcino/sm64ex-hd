...
static const Vtx lll_seg7_vertex_0701A270[] = {
    {{{  -239,      0,    240}, 0, {     0,    992}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   240,      0,    240}, 0, {   992,    992}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   240,      0,   -239}, 0, {   992,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -239,      0,   -239}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
};

// 0x0701A2B0 - 0x0701A2F0
static const Vtx lll_seg7_vertex_0701A2B0[] = {
    {{{  -239,    -45,    240}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xc8}}},
    {{{   240,    -45,    240}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xc8}}},
    {{{   240,    -45,   -239}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xc8}}},
    {{{  -239,    -45,   -239}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xc8}}},
};
